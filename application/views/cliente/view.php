...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Gib Live Brasil | Cliente</title>
    ...
    <body>
        ...
        <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="cliente/novo" class="btn btn-info pull-right">Novo Registro <i class="fa fa-plus"></i></a>
                    </div>       
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Clientes Cadastradas</h4>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            if (empty($data_cli)) :
                                                ...
                                                while ($c->valid()):
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $c->current()->cli_nome; ?></td>
                                                        <td><?php echo $c->current()->desc_cidade . ' / ' . $c->current()->desc_estado; ?></td>
                                                        <td><?php echo $c->current()->cli_bairro; ?></td>
                                                        <td><?php echo $c->current()->cli_tel; ?></td>
                                                        <td><?php echo $c->current()->cli_cel; ?></td>
                                                        <td>
                                                            <a href="cliente/editar/<?php echo $c->current()->id_cli ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Editar</a>
                                                            <button class="btn btn-sm btn-danger btn-delete-cli" data-id="<?php echo $c->current()->id_cli; ?>"><i class="fa fa-trash"></i> Excluir</button>
                                                        </td>
                                                    </tr> 
                                                    <?php
                                                    $c->next();
