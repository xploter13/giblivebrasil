                                ...
                                <fieldset>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="cmbPropri" class="form-control" id="cmbImoPropri" required>
                                                ...
                                                if (empty($propri)) :
                                                    ?>
                                                    <option value="" selected disabled>Nenhum registro encontrado
                                                    </option>
                                                <?php
                                                else:
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtDescricao"
                                                   value="<?php echo $i->current()->imo_desc; ?>"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtCodImovel"
                                                   value="<?php echo $i->current()->imo_cod; ?>"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select id="cmb-type-category" name="cmbCategoria" class="form-control"
                                                ...
                                                <option value="Financiamento Particular">Financiamento Particular
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtQtdDormitorios"
                                                   value="<?php echo $i->current()->imo_qtd_dorm; ?>"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtQtdBanheiros"
                                                   value="<?php echo $i->current()->imo_qtd_ban; ?>"
                                                   maxlength="2" required placeholder="0">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtVagaGaragem"
                                                   value="<?php echo $i->current()->imo_qtd_vag_garg; ?>"
                                                   maxlength="2" required placeholder="0">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtAreaConstruida"
                                                   value="<?php echo $i->current()->imo_area_const; ?>"
                                                   maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtAreaTotal"
                                                   value="<?php echo $i->current()->imo_area_total; ?>"
                                                   maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtComplemento"
                                                   id="inputComplement"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker-" name="cmbEstado" id="cmb-uf"
                                                    data-size="10" data-live-search="true" data-style="btn-white"
                                                    required>
                                                <option value="" disabled selected>Selecione o estado</option>
                                                <?php
                                                if (empty($state)) :
                                                    ?>
                                                    <option value="" disabled selected>Não existem estados cadastrados
                                                    </option>
                                                <?php
                                                else :
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtCep"
                                                   value="<?php echo $i->current()->imo_cep; ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtBairro"
                                                   value="<?php echo $i->current()->imo_bairro; ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="cmbTipoNegociacao"
                                                    id="cmb-type-negotiation"
                                                    required>
                                                <option value=""></option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtDescricaoTaxa"
                                                   value="<?php echo $i->current()->imo_desc_taxa; ?>"
                                                   maxlength="200">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 no-margin">
                                        <div class="pull-right">
                                            <button type="reset" class="btn btn-sm btn-default"><i
                                                        class="fa fa-circle-o"></i>
                                                Cancelar
                                            </button>
                                            <button type="submit" class="btn btn-sm btn-primary m-r-5"><i
                                                        class="fa fa-save"></i>
                                                Salvar
                                            </button>
                                        </div>
