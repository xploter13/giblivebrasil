...
<body>
                                ...
                                <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="cmbPropri" class="form-control" id="cmbImoPropri" required>
                                                ...
                                                <?php
                                                            ...
                                                            while ($p->valid()) :
                                                                ?>
                                                <option value="<?php echo $p->current()->id_proprietario; ?>">
                                                    <?php echo $p->current()->nome; ?>
                                                </option>
                                                <?php
                                                                $p->next();
                                                            endwhile;
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtDescricao" value="<?php echo $i->current()->imo_desc; ?>"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtCodImovel" value="<?php echo $i->current()->imo_cod; ?>"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select id="cmb-type-category" name="cmbCategoria" class="form-control"
                                                required>
                                                <option value=""></option>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtQtdDormitorios" value="<?php echo $i->current()->imo_qtd_dorm; ?>"
                                                maxlength="2" required placeholder="0">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Banheiros:</label>
                                            <input type="text" class="form-control" name="edtQtdBanheiros" value="<?php echo $i->current()->imo_qtd_ban; ?>"
                                                maxlength="2" required placeholder="0">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtVagaGaragem" value="<?php echo $i->current()->imo_qtd_vag_garg; ?>"
                                                maxlength="2" required placeholder="0">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtAreaConstruida" value="<?php echo $i->current()->imo_area_const; ?>"
                                                maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtAreaTotal" value="<?php echo $i->current()->imo_area_total; ?>"
                                                maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" cols="50" id="txt-area-immobile" name="txtObsImovel"
                                                class="form-control"><?php echo $i->current()->imo_obs; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtEndereco" id="inputAddress"
                                                value="<?php echo $i->current()->imo_end; ?>"
                                                maxlength="200" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtComplemento" id="inputComplement"
                                                value="<?php echo $i->current()->imo_comp; ?>"
                                                maxlength="200" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtNumero" maxlength="10"
                                                value="<?php echo $i->current()->imo_num; ?>"
                                                id="inputNumberAddress" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Estado</label>
                                            <select class="form-control selectpicker-" name="cmbEstado" id="cmb-uf"
                                                data-size="10" data-live-search="true" data-style="btn-white" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtCep" value="<?php echo $i->current()->imo_cep; ?>"
                                                maxlength="20" id="inputCEP" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="inputBairro">Bairro</label>
                                            <input type="text" class="form-control" name="edtBairro" value="<?php echo $i->current()->imo_bairro; ?>"
                                                id="inputBairro" maxlength="50" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="cmbTipoNegociacao" id="cmb-type-negotiation"
                                                required>
                                                <option value=""></option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input-currency" name="edtValorImovel"
                                                    value="<?php echo $i->current()->imo_valor; ?>"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input-currency" name="edtValorIptuMensal"
                                                    value="<?php echo $i->current()->imo_valor_iptu; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input-currency" name="edtValorIptuAnual"
                                                    value="<?php echo $i->current()->imo_valor_iptu_anual; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input-currency" name="edtTaxasExtras"
                                                    value="<?php echo $i->current()->imo_taxas_extras; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtDescricaoTaxa" value="<?php echo $i->current()->imo_desc_taxa; ?>"
                                                maxlength="200">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Observações:</label>
                                            <textarea rows="5" cols="50" id="txt-obs-finances" name="txtObservacao"
                                                class="form-control"><?php echo $i->current()->imo_obs_finan; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <!-- Upload Button -->
                                        <input type="file" name="image[]" class="file file-loading" id="file-1"
                                    ...
                                    <div class="col-md-12 no-margin">
                                        <div class="pull-right">
                                            <button type="reset" class="btn btn-sm btn-default"><i class="fa fa-circle-o"></i>
                                                Cancelar</button>
                                            <button type="submit" class="btn btn-sm btn-primary m-r-5"><i class="fa fa-save"></i>
                                                Salvar</button>
                                        </div>
                                    </div>
                                </fieldset>
    ...
    <script>
        ...
        $("#cmb-type-negotiation").val(
            "<?php echo $i->current()->imo_tipo_neg; ?>");
        ...
        $("#file-1").fileinput({
                    ...
                    initialPreview: [
                        "<?php echo base_url() . 'assets/uploads/' . $i->current()->imo_image; ?>"
                    ],
