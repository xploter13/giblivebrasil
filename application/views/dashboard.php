        ...
        <div id="content" class="content">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="widget widget-stats bg-green">
                        ...
                        <div class="stats-info">
                            ...
                            <p>
                                <?php
                                    $number = new ArrayIterator($count_immobile);
                                    while ($number->valid()) {
                                        if (empty($number->current()->amount)) {
                                        ?>
                                        Nenhum imóvel cadastrado
                                <?php
                                    } else {
                                            echo $number->current()->amount;
                                        }
                                        $number->next();                                        
                                    }                                    
                                ?>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="widget widget-stats bg-blue">
                        ...
                        <div class="stats-info">
                            ...
                            <p>
                            <?php
                                    $number = new ArrayIterator($count_crm);
                                    while ($number->valid()) {
                                        if (empty($number->current()->amount)) {
                                        ?>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="widget widget-stats bg-purple">
                        ...
                        <div class="stats-info">
                            ...
                            <p>
                            <?php
                                    $number = new ArrayIterator($count_location);
                                    while ($number->valid()) {
                                        if (empty($number->current()->amount)) {
                                        ?>
                                        Nenhuma visita realizada
                    ...
                    <div class="widget-chart with-sidebar bg-black">
                        ...
                        <div class="widget-chart-sidebar bg-black-darker">
                            ...
                            <ul class="chart-legend">
                                <li><i class="fa fa-circle-o fa-fw text-success m-r-5"></i> 34.0% <span>para
                                        Locação</span></li>
                                <li><i class="fa fa-circle-o fa-fw text-primary m-r-5"></i> 56.0% <span>Alugados</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <h4 class="panel-title">Agendamento de Visitas <span
                                    class="pull-right label label-success"><i class="fa fa-calendar"></i></span></h4>
                        </div>
