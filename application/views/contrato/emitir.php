                                ...
                                <fieldset>
                                    ...
                                    <div class="col-md-12">
                                        <div class="pull-right">
                                            <button type="submit" class="btn btn-sm btn-success m-r-5"><i class="fa fa-cog"></i>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="cmbLocatario" class="form-control" id="cmbLoc" required>
                                                ...
                                                <?php
                                                        ...
                                                        while ($l->valid()) :
                                                            ?>
                                                <option value="<?php echo $l->current()->id; ?>"><?php echo $l->current()->nome; ?>
                                                </option>
                                                <?php
                                                            $l->next();
                                                        endwhile;
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="cmbImovel" class="form-control" id="cmbImo" required>
                                                <option value=""></option>
                                                <?php
                                                    if (empty($imo)):
                                                        ?>
                                                ...
                                                <?php
                                                        ...
                                                        while ($i->valid()) :
                                                            ?>
                                                <option value="<?php echo $i->current()->id; ?>"><?php echo $i->current()->imo_cod.' - '.$i->current()->imo_tipo_imovel; ?>
                                                </option>
                                                <?php
                                                            $i->next();
                                                        endwhile;
