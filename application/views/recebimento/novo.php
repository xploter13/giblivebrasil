                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Cadastro de Recebimento</h4>
                            </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="edtData" id="inputDate" maxlength="20" required/>
                                            </div>
                                        </div> 
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control input-currency" name="edtValor" id="edtValue" placeholder="0,00" required>
                                                </div>
                                            </div>
                                        </div>                                                                    
