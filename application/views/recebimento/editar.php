...
<html lang="pt-br">
    ...
    <head>
        <meta charset="utf-8" />
        <title>.: Gib Live Brasil | Financeiro - Recebimento - Novo :.</title>
        ...
        while ($r->valid()) :
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-inverse">
                                <div class="panel-heading">
                                    ...
                                    <h4 class="panel-title">Alteração de Recebimento</h4>
                                </div>
                                <div class="panel-body">
                                    <div class="msg"></div>
                                    <form id="frm-rec-edit">
                                        <fieldset>
                                            <legend>Dados Básicos</legend>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="inputNome">Cliente</label>
                                                    <input type="text" class="form-control input-focus" name="edtCliente" id="inputNome" value="<?php echo $r->current()->cliente; ?>" maxlength="200" required/>
                                                    <input type="hidden" name="edtIdRecebimento" value="<?php echo $r->current()->id; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="inputDate">Data do Recebimento</label>
                                                    <input type="text" class="form-control" name="edtData" id="inputDate" value="<?php echo $r->current()->data_recebimento; ?>" maxlength="20" required/>
                                                </div>
                                            </div> 
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="cmbFormPag">Forma de Pagamento</label>
                                                    <select class="form-control" name="cmbFormaPag" id="cmbFormPag">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="edtValue">Valor:</label>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">R$</span>
                                                        <input type="text" class="form-control input-currency" name="edtValor" id="edtValue" placeholder="0,00" value="<?php echo $r->current()->valor; ?>" required>
                                                    </div>
                                                </div>
                                            </div>                                                                    
            ...
            <script>
                $(document).ready(function () {
                    App.init();
                    FormPlugins.init();
                    $(".button-rec").addClass('active');

                    $("#cmbFormPag").val("<?php echo $r->current()->pagamento; ?>");
