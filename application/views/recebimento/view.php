...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Gib Live Brasil | Financeiro - Recebimento</title>
    ...
    <body>
        ...
        <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <!-- end breadcrumb -->
                <!-- begin page-header -->
                <h1 class="page-header">Recebimento</h1>
                <!-- end page-header -->

                <!-- begin row -->
                <div class="row">
                    <div class="col-md-12">
                        <a href="recebimento/novo" class="btn btn-info pull-right">Novo Registro <i class="fa fa-plus"></i></a>
                    </div>       
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Recebimentos Cadastrados</h4>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            if (empty($data_rec)) :
                                                ...
                                                while ($r->valid()):
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $r->current()->cliente; ?></td>
                                                        <td><?php echo $r->current()->data_recebimento; ?></td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Exclusão de Recebimento</h4>
                                    </div>
