...
<html lang="pt-br">
    ...
    <head>
        <meta charset="utf-8" />
        <title>.: Gib Live Brasil | Funcionário - Novo :.</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Cadastro de Funcionário</h4>
                            </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="edtDataNasc" id="inputDate" maxlength="20" required/>
                                            </div>
                                        </div> 
