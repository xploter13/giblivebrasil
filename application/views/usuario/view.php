...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Gib Live Brasil | Usuário</title>
                                        ...
                                        <tbody>
                                            ...
                                            if (empty($data_usu)) :
                                                ...
                                                while ($u->valid()):
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $u->current()->nome; ?></td>
                                                        <td><?php echo $u->current()->email; ?></td>
                                                        <td><?php echo $u->current()->login; ?></td>
                                                        <td>
                                                            <?php
                                                            if ($u->current()->nivel === '1') :
                                                                echo 'Administrador';
                                                            else :
                                                                echo 'Básico';
                                                            endif;
                                                        ...
                                                        <td>
                                                            <a href="usuario/editar/<?php echo $u->current()->id; ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Editar</a>
        <!--                                                            <button class="btn btn-sm btn-danger btn-delete-usu" data-id="<?php echo $u->current()->id; ?>"><i class="fa fa-trash"></i> Excluir</button>-->
                                                        </td>
                                                    </tr> 
                                                    <?php
                                                    $u->next();
