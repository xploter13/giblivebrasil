        ...
        while ($u->valid()) :
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-inverse">
                                <div class="panel-heading">
                                    ...
                                    <h4 class="panel-title">Alteração de Usuário</h4>
                                </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control input-focus" name="edtNome" id="inputName" value="<?php echo $u->current()->nome; ?>" maxlength="200" required/>
                                                </div>
                                            </div>                                        
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="inputEmail">Email</label>
                                                    <input type="text" class="form-control" name="edtEmail" id="inputEmail" value="<?php echo $u->current()->email; ?>" maxlength="200" required/>
                                                </div>
                                            </div>                                        
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="inputLogin">Login</label>
                                                    <input type="text" class="form-control" name="edtLogin" id="inputLogin" value="<?php echo $u->current()->login; ?>" maxlength="200" required/>
                                                </div>
                                            </div>                                        
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="pull-right">
                                                        <input type="checkbox" id="cbkUpdatePass"> <small>Alterar senha</small>
                                                    </div>
                                                    <input type="password" class="form-control" name="edtSenha" id="inputPass" maxlength="50" disabled/>
                                                </div>
                                            </div>    
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="cmbLevel">Nível</label>
                                                    <select class="form-control" name="cmbNivel" id="cmbLevel">
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $("#cmbLevel").val("<?php echo $u->current()->nivel; ?>");
