...
<body>
                                ...
                                <fieldset>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-focus" name="edtNome"
                                                value="<?php echo $p->current()->nome; ?>" id="inputNome"
                                                maxlength="200" required />
                                            <input type="hidden" name="edtID"
                                                value="<?php echo $p->current()->id; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="inputCPF-1">CPF</label>
                                            <input type="text" class="form-control" name="edtCPF"
                                                value="<?php echo $p->current()->cpf; ?>" id="inputCPF-1" maxlength="20"
                                                required />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtEndereco"
                                                value="<?php echo $p->current()->endereco; ?>" id="inputAddress"
                                                maxlength="200" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtComplemento"
                                                value="<?php echo $p->current()->complemento; ?>" id="inputComplement"
                                                maxlength="200" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtNumero"
                                                value="<?php echo $p->current()->numero; ?>" maxlength="10"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker-" name="cmbEstado" id="cmb-uf"
                                                ...
                                                <option value="<?php echo $s->current()->id; ?>">
                                                    <?php echo $s->current()->descricao; ?></option>
                                                <?php
                                                                $s->next();
                                                            endwhile;
                                                        endif;
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtCep"
                                                value="<?php echo $p->current()->cep; ?>" maxlength="20"
                                                id="inputCEP" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtBairro"
                                                value="<?php echo $p->current()->bairro; ?>" id="inputBairro"
                                                maxlength="50" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtTelefone"
                                                value="<?php echo $p->current()->telefone; ?>" maxlength="20"
                                                id="inputPhone" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtCelular"
                                                value="<?php echo $p->current()->celular; ?>" maxlength="20"
                                                id="inputMobile" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtEmail"
                                                value="<?php echo $p->current()->email; ?>" maxlength="200"
                                                id="inputEmail" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtNomeConjuge"
                                                value="<?php echo $p->current()->nome_conjuge; ?>" id="inputNomeConj"
                                                maxlength="200" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="edtCPFConjuge"
                                                value="<?php echo $p->current()->cpf_conjuge; ?>" maxlength="20"
                                                id="inputCPF-2" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 no-margin">
                                        <div class="pull-right">
                                            <button type="reset" class="btn btn-sm btn-default"><i
                                                    class="fa fa-circle-o"></i> Cancelar</button>
    ...
    <script src="<?php echo base_url(); ?>assets/plugins/ionRangeSlider/js/ion-rangeSlider/ion.rangeSlider.min.js">
    </script>
